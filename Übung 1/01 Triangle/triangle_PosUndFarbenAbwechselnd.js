...
function init() {
	...
	gl.vertexAttribPointer(vPosition, 2, gl.FLOAT, false, 24, 0); // alle 24 byte kommt nächste variable

    // 7.2 Link data in VBO to shader variables
	const vColor = gl.getAttribLocation(program, "vColor");
	gl.enableVertexAttribArray(vColor);
	gl.vertexAttribPointer(vColor, 4, gl.FLOAT, false, 24, 8); // alle 24 byte kommt nächste variable
